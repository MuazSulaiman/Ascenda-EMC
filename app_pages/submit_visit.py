...
def page_submit_visit():
    ...
    # ✅ NEW: "Other" customer required name + region/city/sector (stored into visits.other_*)
    ...
    with st.spinner("Saving your visit…"):
        ...
        visit_row = {
            ...
            # ✅ NEW: store the typed name + region/city/sector when customer is Other
        ...
        try:
            ...
            # clear "Other Customer" fields after save
