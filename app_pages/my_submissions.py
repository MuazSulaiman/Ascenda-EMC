    ...
    for _, row in page_df.iterrows():
        ...
        if row.get("is_deleted"):
            ...
            cards_html += (
                ...
                f'<div class="ascenda-visit-card" style="background:var(--status-danger-bg);border:1px solid var(--color-border);'
                ...
                f'<div style="font-size:1.125rem;font-weight:700;color:var(--status-danger-text);line-height:1;">{day}</div>'
                f'<div style="font-size:0.7rem;font-weight:600;color:var(--status-danger-text);text-transform:uppercase;'
                f'margin-top:2px;letter-spacing:0.04em;">{month}</div>'
                f'<div style="font-size:0.65rem;color:var(--color-text-subtle);margin-top:1px;letter-spacing:0.02em;">{year}</div>'
                f'</div>'
                ...
                f'<div style="font-size:0.8rem;color:var(--status-danger-text);margin-top:2px;font-style:italic;'
